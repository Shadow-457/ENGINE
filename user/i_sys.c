 ...
 *
 * DOOM key codes relevant to ENGINE:
...
/* ENGINE scancode → DOOM key code translation */
 ...
 * We drain the ENGINE key and mouse ring buffers and post events.
 */
